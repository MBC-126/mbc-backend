...
export interface ApiAnnouncementAnnouncement
  ...
  info: {
    description: 'Marketplace pour vente/achat entre militaires';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['V\u00E9hicule', 'Immobilier', 'Mobilier', '\u00C9lectronique', 'Autre']
    > &
      Schema.Attribute.Required;
    ...
    etat: Schema.Attribute.Enumeration<
      ['disponible', 'vendue', 'supprim\u00E9e']
    > &
      Schema.Attribute.DefaultTo<'disponible'>;
    expirationDate: Schema.Attribute.DateTime;
    images: Schema.Attribute.Media<'images', true>;
    isNegotiable: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCarpoolPassengerCarpoolPassenger
  extends Struct.CollectionTypeSchema {
  collectionName: 'carpool_passengers';
  info: {
    description: 'Table de liaison pour les passagers de covoiturage avec statuts';
    displayName: 'CarpoolPassenger';
    pluralName: 'carpool-passengers';
    singularName: 'carpool-passenger';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    carpool: Schema.Attribute.Relation<'manyToOne', 'api::carpool.carpool'> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::carpool-passenger.carpool-passenger'
    > &
      Schema.Attribute.Private;
...
export interface ApiCarpoolReviewCarpoolReview
  extends Struct.CollectionTypeSchema {
  collectionName: 'carpool_reviews';
  info: {
    description: 'Syst\u00E8me de notation apr\u00E8s covoiturage';
    displayName: 'Carpool Review';
    pluralName: 'carpool-reviews';
    singularName: 'carpool-review';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::carpool-review.carpool-review'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rating: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    reviewee: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    > &
      Schema.Attribute.Required;
...
export interface ApiCarpoolCarpool extends Struct.CollectionTypeSchema {
  collectionName: 'carpools';
  info: {
    description: 'Syst\u00E8me de covoiturage';
    displayName: 'Carpool';
    pluralName: 'carpools';
    singularName: 'carpool';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    arrivalLocation: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departureLocation: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    driver: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    etatCovoiturage: Schema.Attribute.Enumeration<
    ...
    passengers: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    pricePerSeat: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    ...
    tripType: Schema.Attribute.Enumeration<['offre', 'demande']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'offre'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEmergencyAlertEmergencyAlert
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['s\u00E9curit\u00E9', 'm\u00E9t\u00E9o', 'technique', 'autre']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    publishedAt: Schema.Attribute.DateTime;
    requiresAcknowledgment: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    severity: Schema.Attribute.Enumeration<
      ['low', 'medium', 'high', 'critical']
    > &
      Schema.Attribute.Required;
    targetUnits: Schema.Attribute.JSON;
...
export interface ApiInfrastructureBlackoutInfrastructureBlackout
  extends Struct.CollectionTypeSchema {
  collectionName: 'infrastructure_blackouts';
  info: {
    description: "P\u00E9riodes d'indisponibilit\u00E9 des infrastructures";
    displayName: 'Infrastructure Blackout';
    pluralName: 'infrastructure-blackouts';
    singularName: 'infrastructure-blackout';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    end_at: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::infrastructure-blackout.infrastructure-blackout'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInfrastructureInfrastructure
  ...
  info: {
    description: 'Lieux et \u00E9quipements r\u00E9servables';
  ...
  attributes: {
    bookingRules: Schema.Attribute.Component<
      'infrastructure.booking-rules',
      false
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    icsToken: Schema.Attribute.String & Schema.Attribute.Unique;
    images: Schema.Attribute.Media<'images', true>;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    isFreeAccess: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::infrastructure.infrastructure'
    ...
    type: Schema.Attribute.Enumeration<
      ['salle', 'terrain', '\u00E9quipement', 'autre']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    relatedItemId: Schema.Attribute.String;
    relatedItemType: Schema.Attribute.Enumeration<
      ['announcement', 'carpool', 'reservation', 'menu', 'alert']
    >;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<
      [
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "R\u00E9servations d'infrastructures";
  ...
  attributes: {
    ...
    etatReservation: Schema.Attribute.Enumeration<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    carpooldriver: Schema.Attribute.Relation<
      'oneToMany',
      'api::carpool.carpool'
    >;
    carpoolRating: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 0;
    ...
    carpoolReviewsCount: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    successfulSalesCount: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
